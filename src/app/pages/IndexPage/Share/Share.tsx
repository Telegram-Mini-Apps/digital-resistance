  ...
  return (
    <>
      ...
      <Section className={styles.section} title={t('share_letter_link')}>
        {/*fixme*/}
        <p>
          Share this link to this letter with your friends and followers on Telegram, X (ex.
          Twitter), Facebook and VK
        </p>
      ...
      >
        <p className={styles.sectionTextWithImage}>
          Publish stories to social networks to&nbsp;engage more people
      ...
      <Section className={styles.section} title={t('add_badge')}>
        <p className={styles.sectionTextWithImage}>
          {/*fixme*/}
          Add resistance badge to your avatar
